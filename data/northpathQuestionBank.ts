...
export const algorithmParameters: Question[] = [
  {
    ...
    prompt: 'Target max span‑of‑control (enter 0 for no cap)',
    type: 'numeric',
    required: true,
  ...
  },
  {
    id: 'P_2', 
    section: 'Algorithm Parameters',
    prompt: '3‑year cost‑saving target (%)',
    type: 'numeric',
    required: true,
  ...
  },
  {
    id: 'P_4',
    section: 'Algorithm Parameters',
    prompt: 'Immutable units/roles (comma‑separated IDs)',
    type: 'text',
    required: false,
    tags: ['CONSTRAINTS']
  },
  {
    id: 'P_5',
    section: 'Algorithm Parameters',
    prompt: 'Additional success metrics (e.g., NPS, HCAHPS)',
    type: 'text',
    required: false,
    tags: ['METRICS', 'KPI']
  }
...
export const universalUploads: Question[] = [
  {
    ...
    prompt: 'Upload org_units.csv (Unit_ID, Parent_ID, Name, Type, Location)',
    type: 'upload',
    uploadCode: 'U‑01',
    required: true,
    tags: ['ORG_HIERARCHY']
