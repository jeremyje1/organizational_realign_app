  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold text-slate-100 mb-2">AI-Enhanced Analysis Results</h1>
          <p className="text-slate-400">Comprehensive organizational assessment with strategic recommendations</p>
        </div>
      ...
      <Card className="bg-gradient-to-r from-purple-500/10 to-pink-500/10 border-purple-400/30">
        ...
        <CardContent>
          <p className="text-slate-300 leading-relaxed mb-4">{analysis.executiveSummary}</p>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="text-center">
              ...
              <div className="text-sm text-slate-400">Organizational Health</div>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <div className="text-sm text-slate-400">AI Readiness</div>
            </div>
            <div className="text-center">
              ...
              <div className="text-sm text-slate-400">Redundancy Index</div>
            </div>
          </div>
        </CardContent>
      </Card>
                ...
                <div className="space-y-4">
                  {analysis.keyFindings.map((finding, index) => (
                    <div key={index} className="flex items-start gap-3 p-4 bg-slate-800/30 rounded-lg border border-slate-700/50">
                      ...
                      <p className="text-slate-300 leading-relaxed">{finding}</p>
                    </div>
                  ))}
                </div>
              </CardContent>
