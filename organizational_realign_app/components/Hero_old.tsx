            ...
            <div className="space-y-8 text-white">
              ...
              <div className="flex flex-wrap gap-4 animate-fade-in delay-300">
                <div className="flex items-center space-x-2 bg-white/5 backdrop-blur-sm border border-white/10 rounded-full px-4 py-2">
                  <Shield className="w-4 h-4 text-np-success-green" />
                  <span className="text-sm text-blue-200">95% Success Rate</span>
                </div>
                <div className="flex items-center space-x-2 bg-white/5 backdrop-blur-sm border border-white/10 rounded-full px-4 py-2">
                  <BarChart3 className="w-4 h-4 text-np-bright-blue" />
                  <span className="text-sm text-blue-200">$2.4M Avg. Savings</span>
                </div>
                <div className="flex items-center space-x-2 bg-white/5 backdrop-blur-sm border border-white/10 rounded-full px-4 py-2">
                  <Users className="w-4 h-4 text-np-gold" />
              ...
              <div className="space-y-6 animate-slide-up delay-400">
                <div className="pt-8 border-t border-white/20">
                  ...
                  <div className="grid gap-4">
                    ...
                    <div className="bg-gradient-to-r from-np-primary-blue/20 to-np-bright-blue/20 backdrop-blur-sm border border-white/20 rounded-2xl p-6 hover:from-np-primary-blue/30 hover:to-np-bright-blue/30 transition-all duration-300">
                      <div className="flex items-start space-x-4">
                        <div className="w-12 h-12 bg-gradient-to-br from-np-light-blue to-np-bright-blue rounded-xl flex items-center justify-center flex-shrink-0">
                        ...
                        <div className="flex-1">
                          ...
                          <Button 
                            asChild
                            size="lg" 
                            className="w-full bg-gradient-to-r from-np-light-blue to-np-bright-blue hover:from-np-bright-blue hover:to-white text-white font-semibold shadow-lg hover:shadow-xl transition-all duration-300"
                          >
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                      <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-4 hover:bg-white/10 transition-all duration-300">
                        <div className="flex items-center space-x-3 mb-3">
                          <div className="w-8 h-8 bg-np-bright-blue/20 rounded-lg flex items-center justify-center">
                            <Star className="w-4 h-4 text-np-bright-blue" />
                          </div>
                      ...
                      <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-4 hover:bg-white/10 transition-all duration-300">
                        <div className="flex items-center space-x-3 mb-3">
                          <div className="w-8 h-8 bg-np-success-green/20 rounded-lg flex items-center justify-center">
                            <Zap className="w-4 h-4 text-np-success-green" />
                          </div>
                ...
                <div className="relative w-full h-[600px] bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm rounded-3xl border border-white/20 shadow-2xl overflow-hidden group hover:shadow-3xl transition-all duration-500">
                  ...
                  <div className="absolute inset-6 space-y-6">
                    ...
                    <div className="space-y-4">
                      {[
                        { label: 'Organizational Health', value: '87%', color: 'bg-np-success-green' },
                        { label: 'Efficiency Score', value: '72%', color: 'bg-np-bright-blue' },
                        { label: 'Cultural Alignment', value: '91%', color: 'bg-np-gold' },
                        { label: 'Change Readiness', value: '64%', color: 'bg-np-warning-orange' }
                      ].map((metric, index) => (
                        <div key={index} className="bg-white/5 rounded-xl p-4 backdrop-blur-sm border border-white/10">
                          ...
                          <div className="w-full bg-white/10 rounded-full h-2">
                            <div 
                              className={`${metric.color} h-2 rounded-full transition-all duration-1000 delay-${index * 200}`}
                    ...
                    {/* AI Insights Preview */}
                    <div className="bg-gradient-to-r from-np-light-blue/20 to-np-bright-blue/20 rounded-xl p-4 border border-np-light-blue/30">
                      <div className="flex items-center space-x-2 mb-3">
                        <div className="w-6 h-6 bg-np-light-blue rounded-full flex items-center justify-center">
                          <Sparkles className="w-3 h-3 text-white" />
                        </div>
                        <span className="text-sm font-semibold text-np-light-blue">AI Insight</span>
                      </div>
                  ...
                  {/* Floating indicators */}
                  <div className="absolute top-4 right-4 w-3 h-3 bg-np-success-green rounded-full animate-pulse"></div>
                  <div className="absolute bottom-20 left-4 w-6 h-6 bg-np-bright-blue/30 rounded-full animate-pulse delay-500"></div>
                  <div className="absolute top-1/3 right-8 w-4 h-4 bg-np-gold/30 rounded-full animate-pulse delay-1000"></div>
                </div>

                {/* Decorative elements around the main visual */}
                <div className="absolute -top-4 -right-4 w-24 h-24 bg-np-light-blue/20 rounded-full blur-xl animate-pulse delay-700"></div>
                <div className="absolute -bottom-4 -left-4 w-32 h-32 bg-np-bright-blue/20 rounded-full blur-xl animate-pulse delay-1200"></div>
              </div>
            </div>
          </div>
        </div>
